...
_libffi="libffi-3.4.2-3-x86_64.pkg.tar.zst"
source_x86_64=("${_appimage}::https://pan.rainss.cc/navicat/${pkgver}/Navicat_Premium_15_cs-x86_64.appimage"
               "${_glib2}::https://archive.archlinux.org/packages/g/glib2/${_glib2}"
               "${_libffi}::https://archive.archlinux.org/packages/g/glib2/${_libffi}")
noextract=("${_appimage} ${_glib2} ${_libffi}")
sha256sums_x86_64=('65b97d85b024b343864e0bd535dda6198d872df0d6253a646e9d05160a1a6d6b'
                   ...
                   'd42954592486a67bc6485d1d0195166d12dbe1bc5739c73fbeeb2a1df85e2b91')

prepare() {
    chmod +x "${_appimage}" && ./"${_appimage}" --appimage-extract
    tar xvf ${_glib2} -C squashfs-root
    tar xvf ${_libffi} -C squashfs-root
}
